...
#define STRING_CONFIG_H_AUTHOR "(CPA, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "My HyperCube Ready"
...
*/
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 102 } //{ 80, 80, 4000, 500 }
...
/**
   ...
   Override with M203
                                        X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
*/
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 5, 15 }  //{ 300, 300, 5, 25 }
